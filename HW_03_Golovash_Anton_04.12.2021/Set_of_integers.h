...
{
public:
	Set_of_integers() = default;// конструктор по умолчанию
	Set_of_integers(int* set_of_integers[]);// конструктор с параметрами
	...
	Set_of_integers& operator+ (const Set_of_integers& other_object);// объединение двух множеств
	Set_of_integers& operator- (const int index);// удаление элемента из множества
